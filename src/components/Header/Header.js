        ...
        <div className='py-6 px-4 md:px-11 lg:px-32 shadow-md z-20'>
            <div className='flex justify-between'>
                ...
                <div className='flex items-center gap-3 md:gap-6'>
                    <svg onClick={() => navigate('../details')} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-10 h-10 cursor-pointer rounded-full p-2 hover:bg-gray-200 duration-300">
